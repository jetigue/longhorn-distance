...
<div class="column is-8 is-offset-2">
	<div class="card">
		...
		<div class="card-content">
			...
			<form 
				class="form" 
				action="/coach/time_trials/{{$timeTrial->id}}" 
				method="POST" 
				role="form">
				{{ method_field ('PATCH') }}
				{{ csrf_field() }}
				  			...
				  			<div class="control">
				    			<div class="select is-fullwidth">
						      	<select 
				        			...
				        			<option value="{{ old('season_id', $timeTrial->season_id)}}">
				        				{{ $timeTrial->season->name }}
				       				</option>
				  			...
				  			<div class="control">
				    			<div class="select is-fullwidth">
						      	<select 
				        			...
				        			<option value="{{ old('gender_id', $timeTrial->gender_id)}}">
				        				{{ $timeTrial->gender->name }}
				       				</option>
				  			...
				  			<div class="control">
				    			<div class="select is-fullwidth">
						      	<select 
				        			...
				        			<option value="{{ old('distance_id', $timeTrial->distance_id)}}">
				        				{{ $timeTrial->distance->name }}
				       				</option>
				  			...
				  			<div class="control">
				    			<div class="select is-fullwidth">
						      	<select 
				        			...
				        			<option value="{{ old('terrain_type_id', $timeTrial->terrain_type_id)}}">
				        				{{ $timeTrial->terrainType->name }}
				       				</option>
				  			...
				  			<div class="control">
				    			<div class="select is-fullwidth">
						      	<select 
				        			...
				        			<option value="{{ old('timing_method_id', $timeTrial->timing_method_id)}}">
				        				{{ $timeTrial->timingMethod->name }}
				       				</option>
